...
<head>
  ...
  <title>page de gérer les images de slide</title>
  ...
  <div id="app">
      ...
      <form class="layui-form" style="margin: 10px 0;">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" name="name" id="name" placeholder="Nom" autocomplete="off" class="layui-input">
          </div>
        </div>   
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('config',' augmenter récemment')" @click="jump('../config/add.jsp')" type="button" class="layui-btn btn-theme">
    ...
    <div class="product">
      <div class="proBox" v-for="(item,index) in dataList" v-bind:key="index">
        ...
        <div class="proBoxtxt">
          <a :href="'../config/detail.jsp?id='+item.id">Vérifier les détails</a>
        </div>
      </div>
      <div class="clear"></div>
