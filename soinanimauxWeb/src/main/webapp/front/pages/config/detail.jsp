			...
			var vue = new Vue({
				...
				methods: {
						...
						if (count > 0) {
							...
							this.inter = window.setInterval(function() {
								...
								if (_this.count < 0) {
									...
									layer.msg("le promotion a terminé", {
										time: 2000,
										icon: 5
									})
								}
					...
					downFile(url) {
						...
						download.append(
							"<a id=\"down\" href=\"aaaa.txt\" target=\"_blank\" download=\"aaaa.txt\" style=\"display:none\">télécharger ce document</a>");
