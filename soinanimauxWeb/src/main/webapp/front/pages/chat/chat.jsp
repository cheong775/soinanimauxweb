	...
	<body style="overflow-y: hidden;overflow-x: hidden;">
		<div id="app">
			<el-form class="detail-form-content" ref="ruleForm" label-width="80px">
				...
				<div class="clear-float"></div>
				<el-form-item label="publier" prop="ask">
					<el-input v-model="ruleForm.ask" placeholder="publier" clearable></el-input>
				</el-form-item>
				<el-form-item>
					<el-button type="primary" @click="onSubmit">publier</el-button>
				</el-form-item>
			</el-form>
		</div>
