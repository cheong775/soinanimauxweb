	...
	<body style="background: #EEEEEE;">
		...
		<div id="app">
			...
			<div class="line-container">
				<p class="line" style="background: #EEEEEE;"> ajouter l'adresse de reprendre le produit </p>
			</div>
			<!-- 标题 -->
					...
					<form style="margin-top: 20px;" class="layui-form" lay-filter="myForm">
						<div class="layui-form-item layui-form-text">
							...
							<div class="layui-input-block">
								<input type="text" name="name" id="name" required lay-verify="required" placeholder="contact" autocomplete="off"
								 class="layui-input">
							</div>
						</div>
						<div class="layui-form-item layui-form-text">
							...
							<div class="layui-input-block">
								<input type="text" name="phone" id="phone" required lay-verify="required|phone" placeholder="numéro de téléphone" autocomplete="off"
								 class="layui-input">
							</div>
						</div>
						<div class="layui-form-item layui-form-text">
							...
							<div class="layui-input-block" style="width: 300px;text-align: left;">
								<input type="radio" name="isdefault" value="oui" title="non" checked>
								<input type="radio" name="isdefault" value="oui" title="non">
							</div>
						</div>
						<div class="layui-form-item layui-form-text">
							<label class="layui-form-label">sélecte adresse</label>
							<div class="layui-input-block">
								<input type="text" name="address" id="address" required lay-verify="required" placeholder="sélecte adresse" autocomplete="off"
								 class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block" style="text-align: right;margin-right: 30px;">
								<button class="layui-btn btn-submit" lay-submit lay-filter="*">modifier</button>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'laypage'], function() {
				...
				form.verify({
					phone: function(value, item) {
						if (!isMobile(value)) {
							return 'entrez le bonne numéro de téléphone si vous plaît'
						}
					},
				});
