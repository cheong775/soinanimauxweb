...
<html>
	<head>
		...
		<title>adresse de reprendre le produit</title>
	...
	<body style="background: #EEEEEE;">
		...
		<div id="app">
			...
			<div class="line-container">
				<p class="line" style="background: #EEEEEE;"> adressé de reprendre produit </p>
			</div>
			<!-- 标题 -->
				...
				<div class="right-container" style="padding-top: 0;">
					<div class="btn-container" style="margin-bottom: 0;">
						<button id="btn-add" type="button" class="layui-btn layui-btn-lg btn-theme">
							<i class="layui-icon">&#xe654;</i> ajouter nouvelle adresse
						</button>
					</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					deleteClick(id) {
						layui.layer.confirm('confirme de supprimer?', {
							btn: ['supprimer', 'annulé'] //bouton
						}, function() {
							layui.http.requestJson(`address/delete`, 'post', [id], function(res) {
								layer.msg('supprimer avec réussi', {
									time: 2000,
									icon: 6
								}, function(res) {
