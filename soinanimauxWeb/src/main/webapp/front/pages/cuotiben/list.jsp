									...
									<table>
										<thead>
											<tr>
												...
												<th class="product-name"><span class="nobr">Nom de jouer</span></th>
												<th class="product-name"><span class="nobr">questions</span></th>
												<th class="product-name"><span class="nobr">notes</span></th>
												<th class="product-name"><span class="nobr">bonne réponse</span></th>
												<th class="product-name"><span class="nobr">résultats</span></th>
												<th class="product-price"><span class="nobr"> notes finale</span></th>
											</tr>
										</thead>
										<tbody>
											<tr v-for="item in list" :key="item.id">
												...
												<td class="product-price"><span class="amount">{{item.myscore}}points</span></td>
											</tr>
										</tbody>
									</table>
