...
<head>
  ...
  <title>listes de médicament et produit</title>
    ...
    <fieldset class="search-container" style="text-align: center;margin: 50px 0;">
      <form class="layui-form" style="margin: 10px 0;">
        <div class="layui-inline">
          <label class="layui-form-label">nom de médicament</label>
          <div class="layui-input-inline">
            <input type="text" name="yaopinmingcheng" id="yaopinmingcheng" placeholder="nom de médicament" autocomplete="off" class="layui-input">
          </div>
        </div>   
