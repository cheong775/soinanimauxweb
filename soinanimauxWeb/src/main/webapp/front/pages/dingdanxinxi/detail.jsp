			...
			<div class="data-detail">
				<div class="data-detail-breadcrumb">
					<span class="layui-breadcrumb">
						<a href="../home/home.jsp">accueil</a>
						<a><cite>{{title}}</cite></a>
					</span>
				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.onelimittimes" class="detail-item">
							<span>acheter une seul fois</span>
							<span class="desc">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span class="desc">
								{{detail.guige}}
																								...
																								<div class="detail-item">
							<span>entreprise de fabrique</span>
							<span class="desc">
			...
			var vue = new Vue({
				...
				methods: {
					...
					downFile(url) {
						...
						download.append(
							"<a id=\"down\" href=\"aaaa.txt\" target=\"_blank\" download=\"aaaa.txt\" style=\"display:none\">télécharger document</a>");
