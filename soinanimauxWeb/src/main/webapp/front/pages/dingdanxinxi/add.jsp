		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<label class="layui-form-label">numéro de commande</label>
						...
						<div class="layui-input-block">
							<input v-model="detail.jiage" type="text" name="jiage" id="jiage" autocomplete="off" class="layui-input">
                                                                                ...
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">total montant:</label>
						<div class="layui-input-block">
					...
					<div class="layui-form-item">
						<div class="layui-input-block" style="text-align: right;margin-right: 30px;">
							<button class="layui-btn btn-submit" lay-submit lay-filter="*">soumis</button>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        layer.msg("entrez une nombre entier", {
							time: 2000,
							icon: 5
						});
                        return false
