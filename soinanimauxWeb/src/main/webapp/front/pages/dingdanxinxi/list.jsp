...
</head>Page de liste des informations de commande
  ...
  <div id="app">
      ...
      <form class="layui-form" style="margin: 10px 0;">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" name="dingdanbianhao" id="dingdanbianhao" placeholder="numéro de commande" autocomplete="off" class="layui-input">
          </div>
        </div>   
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('dingdanxinxi','nouveau')" @click="jump('../dingdanxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
            <i class="layui-icon">&#xe654;</i> ajouter
          </button>
        </div>
      </form>
    </fieldset>
    ...
    <div class="product">
      <div class="proBox" v-for="(item,index) in dataList" v-bind:key="index">
        ...
        <div class="proBoxtxt">
          <a :href="'../dingdanxinxi/detail.jsp?id='+item.id">vérifier détail</a>
        </div>
      </div>
      <div class="clear"></div>
