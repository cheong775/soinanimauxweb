  ...
  <div id="app">
    ...
    <div class="part5" style="margin-top: 50px;">
      <div class="part2_1">
        ...
        <div class="more">
          <a href="#" @click="jump('../news/list.jsp')">PLUS>></a>
        </div>
      </div>
    ...
    <div class="part2" style="margin-top: 50px;">
      <div class="part2_1">
        <div class="tit">
            <b>Connaissance de santé d'animaux</b>
            <span>DATA SHOW</span>
        </div>
        <div class="more">
            <a href="#" @click="jump('../yixuezhishi/list.jsp')">PLUS>></a>
        </div>
      </div>
      <div class="part2_2">
        <div class="caseBox" v-for="(item,index) in yixuezhishiList" v-bind:key="index">
          <div class="caseBox_1">
            ...
            <div class="hoverbg" style="display: none;">
                <a :href="'../yixuezhishi/detail.jsp?id='+item.id">vérifier les détails</a>
            </div>
          </div>
          <div class="caseBox_2">
