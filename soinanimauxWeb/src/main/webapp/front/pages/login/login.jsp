          ...
          <form class="layui-form">
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0;">
                <input type="text" name="username" required lay-verify="required" placeholder="entrez le compte" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0;">
                <input type="password" name="password" required lay-verify="required" placeholder="entrez le mot de passe" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
            <div class="layui-form-item">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'form', 'http', 'jquery'], function() {
      ...
      form.on('submit(login)', function(data) {
        data = data.field;
        if (!data.role) {
          layer.msg('choisir type de utilisateur', {
            time: 2000,
            icon: 5
          });
          return false;
        ...
        http.request(data.role + '/login', 'get', data, function(res) {
          layer.msg('connecter avec réussi', {
            time: 2000,
            icon: 6
          });
          // 登录凭证
