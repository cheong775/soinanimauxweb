				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">宠物医院信息管理系统</a>
						</div>
						<ul class="nav justify-content-end">
							...
							<li class="nav-item" style="position: relative;">
								...
								<div class="dropdown-menu lochana-box-shadow2 profile animated flipInY">
									<h5>John Willing</h5>
									<a class="dropdown-item web" target="_blank" href="http://localhost:8080/soinanimauxWeb/front/index.jsp" onclick="toFront()">
										<span class="ti-power-off"></span><span class="text">跳到前台</span></a>
									<a class="dropdown-item exit" target="_blank" href="http://localhost:8080/soinanimauxWeb/jsp/login.jsp" onclick="logout()">
