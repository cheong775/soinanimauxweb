		...
		<div id="content">
			...
			<div class="container mt-0">
				<div class="row breadcrumb-bar">
					<div class="col-md-6">
						<h3 class="block-title">Modifier les informations personnelles </h3>
					</div>
					<div class="col-md-6">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><span>gérer des informations personnelles</span></li>
							<li class="breadcrumb-item active"><span>Modifier les informations personnelles</span></li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">L'informations personnelles</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>Nom de utilisateur</label> <input id="username" name="username"
											class="form-control" placeholder="Nom de utilisateur">
									</div>


									<div class="form-group col-md-6 mb-3">
										<button id="submitBtn" type="button"
											class="btn btn-primary btn-lg">Confirme</button>
									</div>
								</div>
							</form>
						</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function validform() {
			return $("#addOrUpdateForm").validate({
				...
				messages : {
					username: {
						required : "nom de utilisateur ne peut pas être vide",
					},
				}
			}).form();
		}
		...
		function addValidation() {
			jQuery.validator
					.addMethod(
							...
							}, "entrez le bonne numéro de téléphone si vous plaît");
			jQuery.validator.addMethod("isIdCardNo", function(value, element) {
				return this.optional(element)
						|| idCardNoUtil.checkIdCardNo(value);
			}, "entrez votre numéro de identité correctement si vous plaît");
		}
