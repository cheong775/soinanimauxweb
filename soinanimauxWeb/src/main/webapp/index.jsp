...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">Accueil</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow min-h200" style="height: 700px;">
							...
							<h1 align="center" style="margin-top: 250px;"><strong>bienvenue à Soinanimaux</strong></h1>
						</div>
					</div>
				</div>
			</div>
	...
	<script>
		...
		if(window.localStorage.getItem("Token") != null && window.localStorage.getItem("Token") != 'null'){
		  ...
		  $('h1 strong').html('Bienvenue+projectName)
		  $('.dropdown-menu h5').html(window.sessionStorage.getItem('username'))
		  $('.sidebar-header h3 a').html(projectName)
		  var token = window.sessionStorage.getItem("token");
		  if(token == "null" || token == null){
		  	alert("Veuillez vous connecter avant de faire l'opération ");
